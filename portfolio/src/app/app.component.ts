...
export class AppComponent {
  ...
  private buildCards(): void {
    const letsgototalkclient = new CardBuilder()
      ...
      .setContent("This is a simple chat client built with Angular and Socket.IO.")
      .setGithub("https://github.com/JavierAcevedoC/letsGoTalkClient")
      .setDemo("https://github.com/JavierAcevedoC/letsGoTalk/raw/master/pics/good.png")
      .build();
    ...
    const letsgototalk = new CardBuilder()
      ...
      .setTitle("LetsGoTalk")
      .setSubtitle("A simple chat client")
      .setContent("An app (server) to chat over the protocol WS written with Go and gorilla/websocket.")
    ...
    const mailgoing = new CardBuilder()
      ...
      .setDemo("https://github.com/JavierAcevedoC/mailGOing/raw/master/pics/email_test.png")
      .build();
    ...
    const alpaca = new CardBuilder()
      ...
      .setDemo("https://github.com/JavierAcevedoC/alpaca/raw/master/pics/example3.png")
      .build();
    ...
    const tmanager = new CardBuilder()
      ...
      .setContent("A tmanager made with signals and the basic and common of angular dev.")
      .setGithub("https://github.com/JavierAcevedoC/tmanager")
      .setDemo("https://github.com/JavierAcevedoC/tmanager/raw/feature/first-look/pics/mobile_first_04.png")
      .build();
